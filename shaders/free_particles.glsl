...
// Recycle particles that fall inside painted cells when a non-water brush
// (vacuum / air / solid) is committed. Frees the slot back onto the free-list
// stack and marks it dead. Dispatched over `capacity` threads.
